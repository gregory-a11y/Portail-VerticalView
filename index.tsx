            ...
            <div className="flex-1">
                ...
                <div className="mt-4 px-6 md:px-8">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute top-[14px] md:top-[18px] h-0.5 bg-gray-200" style={{ left: '8%', right: '8%' }}></div>
                      ...
                      {[
                        ...
                        return (
                          <div key={step.key} className="flex flex-col items-center justify-start">
                            ...
                            <div className={`text-[6.5px] md:text-[10px] mt-1 md:mt-2 font-semibold whitespace-nowrap leading-tight ${
